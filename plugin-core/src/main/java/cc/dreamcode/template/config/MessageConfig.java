...
public class MessageConfig extends OkaeriConfig {
    ...
    @CustomKey("config-gui-open")
    public BukkitNotice guiOpened = BukkitNotice.chat("&cOtworzono gui.");
    @CustomKey("config-command-sent")
    public BukkitNotice commandSent = BukkitNotice.chat("&cWyslano komende [{sent}]");

    @CustomKey("config-command-server-invalid")
    public BukkitNotice commandServerInvalid = BukkitNotice.chat("&cSerwer nie istnieje! Wybierz jeden z: {list}");
}
